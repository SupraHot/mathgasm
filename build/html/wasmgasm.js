...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wasmgasm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'wasmgasm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wasmgasm.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wasmgasm.html.mem" : null;
